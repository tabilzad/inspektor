...
| `@KtorSchema`      | Class, typealias           | No                 | Describe/override a schema (see [Descriptions](../usage/descriptions.md)); on a typealias it applies wherever the alias is used, also from other modules whose alias declaration is on the compile classpath |
